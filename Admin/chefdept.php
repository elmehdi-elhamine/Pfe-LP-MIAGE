...
<body>
                                ...
                                <div class="page-inner py-5">
                                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                        <div>
                                            ...
                                            <h5 class="text-white op-7 mb-2">Chefs des départements </h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container-fluid pt-3">
        <div class="card">
            <div class="card-bdoy">
				...
				$sth = $db->prepare("SELECT * from professeur where isChefDepartement=1");
				$sth->execute(); 
				$result = $sth->fetchAll();
    ...
    <tbody>
		<?php foreach ($result as $result) {?>
			...
			<td><?php echo $result['Etablissement']; ?></td>
...
co	<script src="../assets/js/plugin/jqvmap/maps/jquery.vmap.world.js"></script>
