...
<body>
	<div class="wrapper">
		...
		<div style="padding-top: 15%; padding-left: 10%;" class="container bootstrap snippets bootdey">
		<div class="panel-body inf-content">
    	<div class="row">
        <div class="col-md-4">

             <?php
             echo '<img style="width:250px; border-radius: 50%;" class="img-circle img-thumbnail isTooltip"
              src="../images/'.$_SESSION['Admin']['Image'] .'"/>'; ?>
                ...
                <tbody>
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['Admin']['nom_admin'].'</strong>';?>     
                        </td>
                    </tr>
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['Admin']['prenom_admin'].'</strong>';?>     
                        </td>
                    </tr>
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['Admin']['email'].'</strong>';?>  
                        </td>
                    </tr>
