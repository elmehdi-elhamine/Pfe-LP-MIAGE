    ...
    <div class="container-fluid pt-3 ">
        <div class="card">
            <div class="card-bdoy">
				...
				$sth = $db->prepare("SELECT * from filiere f inner join cycle c on f.id_cycle=c.id_cycle inner join departement d on f.id_departement=d.id_dprtm inner join professeur p on f.coorFiliere=p.id_prof");
				$sth->execute(); 
				$result = $sth->fetchAll();
