	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
				   <img src="img/fac.png" style="width: 100%; height: 60%; background-color: white; border-radius: 5px;" alt="navbar brand" 
				   class="navbar-brand">
				</a>
					...
					<ul class="nav nav-primary">
						...
						<li class="nav-item active">
							<a href="acceuil_vote_admin.php">
								<img src="img/vote.png" alt="..." class="avatar-img avatar avatar-xs" style="font-size:120px;color:white;">
        ...
        <div class="panel-header bg-primary-gradient">
          <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
              <div>
                  <h2 class="text-white pb-2 fw-bold">Liste des notifications</h2>
              </div>
						  <div class="ml-md-auto py-2 py-md-0">
						  	  <button type="button" class="btn btn-secondary btn-round"  lass="btn btn-primary btn-round ml-auto" 
													data-toggle="modal" data-target="#AddRowModal">+  Ajouter une notification
									</button>
							</div>                              
            </div>
          </div>
       ...
       <div class="row">
              ...
              <div class="card-body">
                              ...
                              $statement = $db->prepare($sql);
                              $statement->execute();
                              $notif = $statement->fetchAll(PDO::FETCH_OBJ);?>
												...
												<tr>
													...
													<td>
													  <div class="form-button-action">
															<button type="button" class="btn btn-link btn-primary btn-lg"  lass="btn btn-primary btn-round ml-auto" 
															        data-toggle="modal" data-target="#editRowModal<?php echo $row->Id?>">
																<i class="fa fa-edit"></i>
															</button>
										          <a  href="delete_notif.php?Id=<?php echo $row->Id?>"  onclick="return confirm('voulez Vous  vraiment supprimer ce  champs ?');">
...
<!-- debut Modal update -->
          ...
          <div class="modal fade" id="editRowModal<?php echo $row->Id?>" tabindex="-1" role="dialog" aria-hidden="true">
				              	...
				              	<div class="col-sm-12">
						              <div class="form-group ">
							              <label>Notification</label>
						               	<textarea style="border-color: lightslategrey;" id="addName" type="text" name="Content" class="form-control" 
						               	value=""><?php echo $row->Content;?></textarea>
						               	<input id="addName" type="hidden" name="Id" class="form-control"  value="<?php echo $row->Id ;?>">
						              </div>
				              	</div>
				              </div>																							
	...
	<div class="modal fade" id="AddRowModal" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
	            <div class="modal-content">
		            <div class="modal-header no-bd">
				            <h5 class="modal-title">
				               <span class="fw-mediumbold">Ajouter une nouvelle notification</span> 
				            </h5>
				            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
			               	 <span aria-hidden="true">&times;</span>
				            </button>
	              ...
	              <div class="modal-body">
                		<form method="POST" action="Add_notif.php">
			               	<div class="row">
				              	<div class="col-sm-12">
						              <div class="form-group ">
							              <label>Notification</label>
						               	<textarea style="border-color: lightslategrey;" id="addName" type="text" name="Content" class="form-control" value="" ></textarea>
						               	<input id="addName" type="hidden" name="Id" class="form-control"  value="<?php echo $row->Id ;?>">
						              </div>
				              	</div>
				              </div>																							
		                  <div class="modal-footer no-bd">
			                   <button type="submit" id="addRowButton" class="btn btn-primary">Envoyer</button>
			                   <button type="button" class="btn btn-danger" data-dismiss="modal">annuler</button>
			                </div>
		                </form>
                </div>
