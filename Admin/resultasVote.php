...
$con  = mysqli_connect("localhost","u792206106_admin","5omBbjNBi-Fp7yg0","u792206106_departements");
 if (!$con) {
     # code...
...
left join departement d on d.id_dprtm=p.id_departement
 ...
 WHERE p.id_poste='$id_poste' and e.id_election='$election'
 ...
 ?>						
						<div class="col-md-10 ml-auto mr-auto">
							<div class="card ">
								<div class="card-header" style="background-color: #D7D9E7;">
									<div class="card-title text-center "><b> Resultas de vote</b></div>
									
								</div>
								<div class="card-header">
									<div class="card-title"><?php 

									 $poste=$_GET['nom_poste'] ;
                                echo "<b><b style=color:#546BFA ;>Candidature </b> : $poste</b>";
                                   ...
                                   <?php
                                    $dept=$_GET['nom_dprtm'];
                                    $filiere=$_GET['intitule_filiere'];
if (empty($filiere)) {
	echo "<b><b style=color:#546BFA;font-size: 0.8em;>Département</b> : $dept</b>";
} else  if(empty($dept)){
	echo "<b ><b style=color:#546BFA;font-size: 0.87em;>Filière </b> : $filiere</b>";
}
