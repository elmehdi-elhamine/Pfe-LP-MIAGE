...
<?php } ?>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name="Etablissement" value="fsjes ain sebaa" class="form-control" id="Etablissement" placeholder="Etablissement">
    </div>
	<div class="form-group col-md-4">
      <label for="Departement">Departement d'attache de la filiere</label>
      <input type="text" name="Departement" class="form-control" value="<?=$_SESSION['nouvelleFiliere']['etape2']['departement']?>" id="Departement" placeholder="Departement">
    </div>
  </div>
  <div class="form-row">
  <div class="form-group col-md-6">
    <label for="intitule">intitule</label>
    <input type="text" name="intitule" class="form-control" name="intitule" id="intitule" placeholder="intitule">
	
  </div>
  <div class="form-group col-md-6">
    <label for="langue">Langue</label>
    <input type="text" name="langue" class="form-control" name="langue" id="langue" placeholder="langue">
	<?php
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="diplome" id="diplome" placeholder="diplome">
  </div>
  <div class="form-row">
    <div class="form-group col-md-6">
	<label for="CoordFiliere">Coordonnateur de filiere</label>
      <input type="text" value="<?=$_SESSION['professeur']['nomPrenom_prof']?>" class="form-control" id="CoordFiliere">
	  <input type="hidden" name="CoordFiliere" value="<?=$_SESSION['professeur']['id_prof']?>" class="form-control" id="IdCoordFiliere">

    </div>
    <div class="form-group col-md-6">
	<label for="CoordDepartement">Coordonnateur de deprtement d'attache</label>
	<?php
	  $sth = $db->prepare("SELECT p2.nomPrenom_prof,p2.id_prof from professeur p inner join liste_modules lm on p.id_prof=lm.id_prof inner join filiere f on lm.id_filiere=f.id_filiere inner join departement d on f.id_departement=d.id_dprtm INNER JOIN professeur p2 on p2.id_prof=d.chefDepartement where p.id_prof=:id_prof;");
	  $sth->bindValue(':id_prof', $_SESSION['professeur']['id_prof']); 
	  $sth->execute(); 
	  $result=$sth->fetch(PDO::FETCH_ASSOC);
	 
	?>
      <input type="text" value="<?=$result['nomPrenom_prof']?>" name="coordDepartement" class="form-control" >
    </div>
  </div>
  <button type="submit" name="suivant2" class="btn btn-primary btn-block">suivant</button>
</form>
