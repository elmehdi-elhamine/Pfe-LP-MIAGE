...
<!------------------------------ Navbar & sidebar menu --------------------------------------------------------------------------------------->
  ...
  Clickez ici pour modifier vos donnees
</button>
<div class="modal fade" id="myModal">
  ...
  <div class="form-row">
    ...
    <label for="validationDefault02">Nom et Prenom</label>
  ...
  <div class="form-row">
    ...
    <div class="col-md-4 mb-3">
    <label for="validationDefault02">Anciennete</label>
    <input type="number" class="form-control" id="Anciennete" name="Anciennete" placeholder="Anciennete"  required>
    </div>
    <div class="col-md-4 mb-3">
    <label for="validationDefault02">Tele</label>
  ...
  <div class="form-row">
    ...
    <input type="text" class="form-control" id="validationDefault01" name="ville" placeholder="First name"  required>
    </div>
    <div class="col-md-6 mb-3">
    <label for="validationDefault02">Type</label>
    <input type="text" class="form-control" id="validationDefault01" name="type" placeholder="First name"  required>
    </div>
    
  </div>
  <div class="form-row">
    <div class="col-md-6 mb-3">
    <label for="validationDefault02">Specialite</label>
    <input type="text" class="form-control" id="validationDefault01" name="specialite" placeholder="First name"  required>
    </div>
    <div class="col-md-6 mb-3">
    <label for="validationDefault02">Grade</label>
    <input type="text" class="form-control" id="validationDefault01" name="Grade" placeholder="First name"  required>
    </div>
  ...
  <label class="custom-file-label" accept="image/jpeg, image/png" for="customFile">Photo</label>
</div>
    </div>
    <div class="col-md-6 mb-3">
    <div class="custom-file">
    
  <input type="file" name="cv" accept="application/pdf" required class="custom-file-input" id="customFile">
  <label class="custom-file-label" accept="application/pdf" for="customFile">CV</label>
</div>
    </div>
    
  </div>
  <button class="btn btn-primary btn-block" name="submit" type="submit">Submit form</button>
</form>    
        </div>
      </div>
